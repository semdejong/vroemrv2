      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Vroemr is een moderne web app gebouwd om rijscholen te ontzien, met
            features zoals leerlingen administratie, digitale leskaarten,
            agenda, en een website builder zodat je jouw rijschool gelijk
            voorziet van een website.
          </p>
        </div>
            ...
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Bouw een website voor je rijschool met onze website builder.
                </p>
              </div>
            </div>
          </div>
